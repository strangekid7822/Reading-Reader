...
export default function ArticleReader({ height, children }) {
  return (
    <main
      className="mt-0 overflow-y-auto py-4 px-2 sm:px-4 md:px-8 bg-white/80 backdrop-blur-sm my-4 shadow-sm border border-gray-100 scrolling-touch select-none"
      style={{ height }}
    >
